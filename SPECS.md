...
**ActivityLog Action:** `LOGIN` · `LOGOUT` · `SUBMIT_APP` · `UPDATE_STATUS` · `APPROVE` · `REJECT` · `CREATE_SERVICE` · `UPDATE_SERVICE` · `DELETE_SERVICE` · `CREATE_USER` · `UPDATE_USER` · `DELETE_USER` · `LOCK_USER` · `CREATE_DEPT` · `UPDATE_DEPT` · `DELETE_DEPT` · `ASSIGN_STAFF` · `UPLOAD_DOC` · `DELETE_DOC` · `EXPORT` · `IMPORT`
